...
public enum ResultCode {
    ...
    NO_PATIENT_ERROR(400, "未查询到就诊人信息"),
    ...
    DOCTOR_CATEGORY__ERROR(601,"仅能设置问诊医生!"),

    DOCTOR_RECOMMENDED_NUM_ERROR(602,"首页推荐显示最多5个!"),

    DOCTOR_RECOMMENDED_ONE_NUM_ERROR(603,"首页推荐显示至少1个!");
    final int code;
    final String msg;
}

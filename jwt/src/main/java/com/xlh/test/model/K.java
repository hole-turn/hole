 ...
 */
public class K {
    public static final String appid = "f0a4b3883cf600d8ca838b7a05021b7c";
    public static final String appScrt = "51d1df44005fc6e4bbe335e3a41bab470c1c8776";
    public static final String tokenUrl = "http://openplat.dev.shuzutech.com/openplat/dev/refreshAccessToken";
    public static final String kpurl = "http://paymgmt.dev.shuzutech.com/invoice/business";
...
//        chonghong();
    ...
    private static void kaipiao() throws IOException {
        ...
        builder.setKpzdbs("497013594916");
//        builder.setJqbh("661619914111");
        ...
        bodyBuilder.setSpsl("");
        bodyBuilder.setDj("");
        BigDecimal totalPayPrice = new BigDecimal("10");
        totalPayPrice = totalPayPrice.setScale(2, BigDecimal.ROUND_HALF_UP);
        //含税金额
        BigDecimal taxInclusiveAmount = totalPayPrice.divide((BigDecimal.ONE.add(new BigDecimal("0.06"))), RoundingMode.HALF_UP);
        bodyBuilder.setJe(taxInclusiveAmount.setScale(2, BigDecimal.ROUND_HALF_UP).toString());
        bodyBuilder.setSl("0.06");
        bodyBuilder.setSe(totalPayPrice.subtract(taxInclusiveAmount).setScale(2, BigDecimal.ROUND_HALF_UP).toString());
        bodyBuilder.setSpbm("1060512990000000000");
//        bodyBuilder.setZxbm("11");
    ...
    private static void chonghong() throws IOException {
        HashMap<String, Object> map = Maps.newHashMap();
        map.put("appId", prodappid);
        map.put("appScrt", prodappScrt);
        String post = HttpUtil.post(prodtokenUrl, map, 2000);
...
//        builder.setYfphm("");
        //冲红用
        builder.setYfpdm("033022200111");
        builder.setYfphm("61535211");
        builder.setSprsjh("");
        builder.setNotify_url("https://dev.91medicine.net/gateway/cshop-server/cloud/invoice/callback");
        builder.setFyxmCount(1);
        builder.setGroups("");
        ...
        //含税金额
        BigDecimal taxInclusiveAmount = totalPayPrice.divide((BigDecimal.ONE.add(new BigDecimal("0.06"))), RoundingMode.HALF_UP);
        bodyBuilder.setJe(taxInclusiveAmount.setScale(2, BigDecimal.ROUND_HALF_UP).negate().toString());
        bodyBuilder.setSl("0.06");
        bodyBuilder.setSe(totalPayPrice.subtract(taxInclusiveAmount).setScale(2, BigDecimal.ROUND_HALF_UP).negate().toString());
        bodyBuilder.setSpbm("1060512990000000000");
//        bodyBuilder.setZxbm("11");
        bodyBuilder.setYhzcbs("0");
        bodyBuilder.setLslbs("");

...
import com.xlh.entity.THospitalMeetingDataEntity;
...
public interface THospitalMeetingDataMapper extends BaseMapper<THospitalMeetingDataEntity> {
    ...
    @Select("SELECT\n" +
            ...
            "\tFROM\n" +
            "\t\tt_hospital_meeting_data \n" +
            "\tORDER BY\n" +
            "\t\tRAND() \n" +
            "\t\tLIMIT 1")
    HospitalMeetingVo getRandom();

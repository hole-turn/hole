package com.xlh.pay.core.client.impl.wx;
...
import com.xlh.pay.common.FileUtils;
import com.xlh.pay.common.ObjectUtils;
import com.xlh.pay.common.PayChannelEnum;
import com.xlh.pay.core.client.PayCommonResult;
import com.xlh.pay.core.client.dto.*;
import com.xlh.pay.core.client.impl.AbstractPayClient;
import lombok.extern.slf4j.Slf4j;

import java.util.Objects;

import static com.alibaba.fastjson.JSONObject.toJSONString;
import static com.xlh.pay.core.client.impl.wx.WXCodeMapping.CODE_SUCCESS;
import static com.xlh.pay.core.client.impl.wx.WXCodeMapping.MESSAGE_SUCCESS;
...
//        }
    ...
    private WxPayUnifiedOrderV3Result.JsapiResult unifiedOrderV3(PayOrderUnifiedReqDTO reqDTO) throws WxPayException {
        ...
        request.setAmount(new WxPayUnifiedOrderV3Request.Amount()
                        // 单位分
                        .setTotal(reqDTO.getAmount().intValue()));

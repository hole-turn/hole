...
public class BaseMessageConf {
    ...
    public static final String BLOG_NO_OPEN_COMMENTS = "本贴子未开启评论功能";
    ...
    public static final String BLOG_UNDER_THIS_TAG = "该标签下还有贴子！";
    ...
    public static final String COMMIT_ERROR = "内容含有违法违规内容";
    ...
    public static final String PLEASE_CONFIGURE_BLOG_COUNT = "请先到参数配置，配置贴子显示数量";
    ...
    public static final String PLEASE_CONFIGURE_SYSTEM_PARAMS = "请先到后台参数配置，配置贴子相关参数";
